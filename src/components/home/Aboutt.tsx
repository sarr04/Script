  ...
  return (
    <section className="relative  ">
      <img
        ...
        className="h-[858px] absolute right-0 bottom-[-50%]  z-0"
      />
      <div className="container mx-auto lg:flex flex-col justify-center items-center min-h-screen   ">
        <div className="text-black rounded-2xl sm:ml-8 bg-white sm:mt-80  lg:p-8 lg:w-full lg:max-w-4xl">
        ...
        <div className="relative lg:mt-16 lg:w-full  lg:max-w-5xl">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 p-8 text-center">
            <div className=" relative bg-gradient-to-r from-orange-400 to-pink-500 lg:p-6 rounded-lg lg:flex lg:flex-col lg:items-center lg:text-center shadow-md">
              ...
              <h2 className="text-4xl font-bold lg:mb-2 sm:ml-11  text-white">
                10+
              </h2>
            ...
            <div className=" relative bg-gradient-to-r from-orange-400 to-pink-500  lg:p-6 rounded-lg lg:flex lg:flex-col lg:items-center lg:text-center shadow-md">
              ...
              <p className="text-lg font-semibold text-white">Attendees</p>
            </div>
          </div>
        </div>
      </div>
