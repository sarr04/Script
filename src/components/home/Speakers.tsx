...
export default function Speakers() {
  return (
    <div className="pl-6 pr-6 overflow-hidden relative z-10">
      <div className="block justify-center items-center min-h-screen ml-12 mr-12 ">
        <div className="text-black rounded-2xl bg-white h-150 w-170 relative z-20">
          <h4 className="flex justify-center items-center text-center pt-10 bg-white ">
          ...
          <h4 className="flex justify-center items-center text-center pb-5">
            Meet the visionaries shaping the future of social media.
          </h4>
        </div>
        <div className="bg-gradient-to-r from-orange-400 to-pink-500 rounded-2xl mb-24 relative z-20">
